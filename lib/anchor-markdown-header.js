/**
 * used by anchor-markdown-header
 * modify it
 * https://raw.githubusercontent.com/thlorenz/anchor-markdown-header/master/anchor-markdown-header.js
 */
'use strict';
 ...
 */
module.exports = function anchorMarkdownHeader(header, uri, mode, repetition, moduleName) {
  ...
  return '[' + header + '](' + uri + '#' +customEncodeURI(href) + ')';
};